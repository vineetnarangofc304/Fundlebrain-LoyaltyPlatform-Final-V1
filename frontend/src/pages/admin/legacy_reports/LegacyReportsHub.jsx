...
const SECTIONS = [
  {
    ...
    items: [
      { to: "/admin/raw-reports/customer", icon: Users, label: "Customer Data Summary",
        desc: "Customer counts grouped by location / tier / month — bar chart + table" },
      { to: "/admin/raw-reports/transaction", icon: Receipt, label: "Transaction Summary",
        desc: "Total Points / Purchase / Bills / Unique Customers by location group" },
      { to: "/admin/raw-reports/repeat", icon: RefreshCw, label: "Repeat Purchase Summary",
        desc: "Repeat-purchase counts split as Total / Current (90d) / Earlier per location" },
      { to: "/admin/raw-reports/earn-redeem", icon: Coins, label: "Earn Burn Summary",
        desc: "Earn / Redeem / Bonus / Expired / Liability per location" },
      { to: "/admin/raw-reports/customer-by-visit", icon: BarChart3, label: "Customers by Visits",
  ...
  },
  {
    ...
    items: [
      { to: "/admin/dashboards/campaign-performance", icon: Megaphone, label: "M'ktg Campaign ROI",
      ...
      { to: "/admin/dashboards/campaign-performance", icon: MessageSquare, label: "WhatsApp Campaign ROI",
        desc: "WhatsApp channel breakdown — coming soon as a dedicated view" },
      { to: "/admin/dashboards/campaign-performance", icon: Radio, label: "RCS Campaign ROI",
