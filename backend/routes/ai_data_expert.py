...
EXPERT_TOOL_SCHEMAS: List[Dict[str, Any]] = [
    {
        ...
        "function": {
            ...
            "description": (
                ...
                "TIMEZONE: when you GROUP or DISPLAY a calendar date/time from these fields, render it in IST "
                "with $dateToString/$dateTrunc using timezone 'Asia/Kolkata' (never slice the raw string — it "
                "may be UTC and is off-by-one near midnight; the dashboard shows IST). "
